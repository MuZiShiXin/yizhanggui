...
@interface TheTwoViewController ()
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        _mainTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight-([_gaodu isEqualToString:@"2"]?163:213))];
...
- (void)httpRequest
{
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(Global.userInfoId),@"zhangGuiId",@(2),@"zhuangTai", nil];
