...
@interface FOURSViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)httpRequest
{
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(Global.userInfoId),@"userInfoId",@(self.CoutPage),@"pageNum",@(10),@"pageSize",@(4),@"type", nil];
