...
@interface ONESViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ONESViewController
...
- (void)httpRequest
{
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys:@(Global.userInfoId),@"userInfoId",@(self.CoutPage),@"pageNum",@(10),@"pageSize",@(1),@"type", nil];
