...
- (void)setUpsearch{
    ...
    lineView.backgroundColor = [UIColor hx_colorWith8BitRed:242 green:242 blue:242 alpha:1.0];
    ...
    bgView.backgroundColor = [UIColor hx_colorWith8BitRed:242 green:242 blue:242 alpha:1.0];
