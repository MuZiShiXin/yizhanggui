...
-(void)ym_setSearchBar{
    ...
    _ym_searchBar.backgroundColor = [UIColor whiteColor];
...
-(void)ym_setNavView{
    ...
    [closeBtn setImage:[UIImage imageNamed:@"YMCitySelect.bundle/btn_navigation_close"] forState:UIControlStateNormal];
